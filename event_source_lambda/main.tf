...
module "event_source_lambda" {
  ...
  depends_on = [ aws_cloudwatch_log_group.event_source_lambda ]
}

resource "aws_iam_role_policy_attachment" "AWSLambdaVPCAccessExecutionRole" {
    role       = module.event_source_lambda.lambda_role_name
    policy_arn = "arn:aws:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole"
}

resource "aws_cloudwatch_log_group" "event_source_lambda" {
...
resource "aws_lambda_event_source_mapping" "event_source_mapping" {
  ...
  function_name                       = module.event_source_lambda.lambda_function_arn
